...
class Pagofacil extends PaymentModule
{
    ...
    public function uninstall()
    {
        if (!Configuration::deleteByName('PF_API_USER')
            ...
            || !Configuration::deleteByName('PF_ID_ECOMMERCE')
    ...
    {
       $this->context->controller->addJS($this->_path.'views/js/pagofacil.js');
    }
    ...
    public function getContent()
    {
        ...
        if(Tools::isSubmit('submit'.$this->name)) {
            ...
            $pf_id_ecommerce   = empty(strval(Tools::getValue('PF_ID_ECOMMERCE'))) ? 'Prestashop Api' : strval(Tools::getValue('PF_ID_ECOMMERCE'));
            ...
            else
            {
                ...
                Configuration::updateValue('PF_ID_ECOMMERCE',  $pf_id_ecommerce);
    ...
    public function renderForm()
    {
        $fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'text'
                    ,'label' => 'E-Commerce platform Id'
                    ,'name' => 'PF_ID_ECOMMERCE'
                    ,'size' => 60
                    ,'required' => true
                ),
                array(
        ...
        $helper->fields_value['PF_ID_ECOMMERCE']     = Configuration::get('PF_ID_ECOMMERCE');
