...
class PagofacilValidationModuleFrontController extends ModuleFrontController
{
    public function postProcess()
    {
        ...
        $data = array(
            ...
            , 'Source' => urlencode(Configuration::get('PF_ID_ECOMMERCE'))
        ...
        //$url = 'https://www.sandbox.pagofacil.tech/Wsrtransaccion/index/format/json';
        
        if (Configuration::get('PF_ENVIRONMENT') == '2') {
            $url = 'https://www.pagofacil.net/ws/public/Wsrtransaccion/index/format/json';
            //$url = 'https://www.pagofacil.net/Wsrtransaccion/index/format/json';
        }
